<?php /* Smarty version 2.6.25-dev, created on 2016-05-20 10:21:47
...
<div class="col-md-5">
    ...
    <form id="ajax-form" role="form" class="form-horizontal" method="post" action="javascript:void(null);">
        <div class="form-group">
            <div class="col-sm-8">
                <input type="text" style="display: none" value="<?php echo $this->_tpl_vars['ad']->id; ?>
...
" name="price" id="price" maxlength="9" placeholder="Введите цену" class="form-control">
        ...
        <div class="form-group">
            <div class="buttons col-sm-offset-6 col-sm-6" align="right">
                ...
                <?php else: ?> 
                <button name="undefined" id="create">Создать</button>
                <?php endif; ?>  
            </div>      
        </div>
    </form>
...
<div class="col-md-7">
    <center><h2>Объявления</h2></center><br>
