<?php /* Smarty version 2.6.25-dev, created on 2016-04-25 07:32:23
 ...
 ?>
   ...
   <DIV class="main"> 
        <form  method="post" align="center" name="form"> 
            <div class="field">
                <input type="radio" value="0" name="private" id="mr" <?php if ($this->_tpl_vars['ad']->private == 0): ?> checked="" <?php endif; ?>><label class="formLabelAuto">Частное лицо</label>
                <input type="radio" value="1" name="private" id="mr" <?php if ($this->_tpl_vars['ad']->private == 1): ?> checked="" <?php endif; ?>><label class="formLabelAuto">Компания</label>
            </div>
            <div class="field">
                <label>Ваше имя </label><span>*</span>
                <input type="text" value="<?php echo $this->_tpl_vars['ad']->seller_name; ?>
...
" name="title" maxlength="50">
            ...
            <div class="field">
                ...
                <textarea name="description" maxlength="3000"><?php echo $this->_tpl_vars['ad']->description; ?>
</textarea>
            </div>
            <div class="field">
...
" name="price" maxlength="9">
    ...
    <?php if (is_array ( $this->_tpl_vars['ads_list'] )): ?>
        <center>
        <table>
            <tr>
                <th width="40px">#</th>
...
?>
            <tr>
                ...
                <td><a href="?id=<?php echo $this->_tpl_vars['ad_l']['id']; ?>
"><?php echo $this->_tpl_vars['ad_l']['title']; ?>
</a></td>
                <td><?php echo $this->_tpl_vars['ad_l']['price']; ?>
 руб.</td>
                <td><?php echo $this->_tpl_vars['ad_l']['seller_name']; ?>
</td>
                <td><a href="?delete=<?php echo $this->_tpl_vars['ad_l']['id']; ?>
">Удалить</a></td>
            </tr>    
