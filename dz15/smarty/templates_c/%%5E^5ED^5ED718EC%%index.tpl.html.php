...
?>
 ...
 руб.</td>
                ...
                <td><button type="button" id="<?php echo $this->_tpl_vars['ad_l']->id; ?>
" class="delete btn btn-default btn-sm"><span class="glyphicon glyphicon-trash"></span></button>&nbsp;&nbsp;<a href="?id=<?php echo $this->_tpl_vars['ad_l']->id; ?>
