<?php /* Smarty version 2.6.25-dev, created on 2016-05-07 18:37:38
...
" name="title" class="form-control" id="title" maxlength="50" placeholder="Введите название объявления">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <textarea name="description" maxlength="3000" rows="3" class="form-control"><?php echo $this->_tpl_vars['ad']->description; ?>
</textarea>
            </div>
        </div>
        <div class="form-group">
...
" name="price" maxlength="9" placeholder="Введите цену" class="form-control">
                <p class="help-block">Поле обязательно для заполнения</p>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-offset-4 col-sm-8">
                <div class="control-group error " class="form-control">
                    <div class="controls">
                        ...
                        <p class="bg-danger"><?php echo $this->_tpl_vars['err']; ?>
</p>
                        <?php endif; ?>  
                    </div>  
                </div>  
...
"><span class="glyphicon glyphicon-trash"></span></a>&nbsp;&nbsp;<a href="?id=<?php echo $this->_tpl_vars['ad_l']->id; ?>
"><span class="glyphicon glyphicon-pencil"></span></a></td>
    ...
    <div class="col-md-12">
        <center>
            <p><a href="?delete=0"><br>Удалить все объявления</a></p>
        </center>
        <?php else: ?>
